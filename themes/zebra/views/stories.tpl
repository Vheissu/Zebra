				...
				<div class="story-row">
					...
					<div class="story-meat">
						...
						<div class="story-meta">
							<p>by <a href="user/{strtolower(get_username($story->user_id))}">{strtolower(get_username($story->user_id))}</a> {timespan($story->created, time(), 1)} ago | <a href="story/{$story->id}/{$story->slug}#comments">{count_story_comments($story->id)} comments</a></p>
						</div>
					</div>
				</div>
			{/foreach}
